    ...
    <section id="about" className="py-16">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className='text-left'>
          ...
          <p className="mt-3 text-gray-600">That’s when I discovered my true passion, which is software engineering, with a special focus on front-end development. Since then, I’ve dedicated myself to mastering HTML, CSS, JavaScript, React, and modern front-end technologies. Alongside this, I’m also deeply passionate about integrating AI tools and models into my development workflow — using them to enhance productivity, improve user experience, and streamline problem-solving.</p>
